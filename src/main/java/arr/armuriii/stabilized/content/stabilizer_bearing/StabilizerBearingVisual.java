...
public class StabilizerBearingVisual extends OrientedRotatingVisual<StabilizerBearingBlockEntity> {

    private final RotatingInstance topShaft;
    private final RotatingInstance cogInstance;

    public StabilizerBearingVisual(final VisualizationContext context, final StabilizerBearingBlockEntity blockEntity, final float partialTick) {
        ...
        this.cogInstance = this.instancerProvider().instancer(AllInstanceTypes.ROTATING, Models.partial(StabilizedPartialModels.STABILIZER_BEARING_COG))
                .createInstance()
